...
```
pkgs <- c(  "afex", "aplpack", "arm", "babynames", "boot", "broom", "car", 
            "CBPS", "cobalt", "cowplot", "devtools", "ebal", "Epi", "ez", 
            ...
            "sandwich", "sessioninfo", "simputation", "skimr", "spelling", 
            "styler", "survey", "survival", "survminer", "tableone", 
            "tidymodels", "tidyverse", "twang", "usethis", "vcd", "viridis")
